...
for it in range(1,NN):
    ...
    T=0.04*it/NN
    EF=-0.09
    dop=2*(0.5-dd(EF,-0.5908,0.0962,-0.1306,-0.0507,0.0939)+0.05)       ##### 2
    aa=AMAX(dop)[1]
    ww=AMAX(dop)[0]
    print ww
    ...
    EF=-0.11
    dop=2*(0.5-dd(EF,-0.5908,0.0962,-0.1306,-0.0507,0.0939)+0.05)     ###### 3
    aa=AMAX(dop)[1]
    ww=AMAX(dop)[0]
    print ww
    ...
    EF=-0.13
    dop=2*(0.5-dd(EF,-0.5908,0.0962,-0.1306,-0.0507,0.0939)+0.05)      ####### 4
    aa=AMAX(dop)[1]
    ww=AMAX(dop)[0]
    print ww
    ...
    EF=-0.14
    dop=2*(0.5-dd(EF,-0.5908,0.0962,-0.1306,-0.0507,0.0939)+0.05)
    aa=AMAX(dop)[1]
    ww=AMAX(dop)[0]
    print ww
    gg2=CCT(EF,T,-0.5908,0.0962,-0.1306,-0.0507,0.0939,dop,aa,ww)[0]    ######## 5
    ...
    ww=AMAX(dop)[0]
    print ww
    gg3=CCT(EF,T,-0.5908,0.0962,-0.1306,-0.0507,0.0939,dop,aa,ww)[0]    ########## 6
    ...
    ww=AMAX(dop)[0]
    print ww
    gg4=CCT(EF,T,-0.5908,0.0962,-0.1306,-0.0507,0.0939,dop,aa,ww)[0]   ######### 7
    ...
    ww=AMAX(dop)[0]
    print ww
    gg5=CCT(EF,T,-0.5908,0.0962,-0.1306,-0.0507,0.0939,dop,aa,ww)[0]    ########   8
    ...
    ww=AMAX(dop)[0]
    print ww
    gg6=CCT(EF,T,-0.5908,0.0962,-0.1306,-0.0507,0.0939,dop,aa,ww)[0]     ########  9 
    ...
    ww=AMAX(dop)[0]
    print ww
    gg7=CCT(EF,T,-0.5908,0.0962,-0.1306,-0.0507,0.0939,dop,aa,ww)[0]     ########## 10
