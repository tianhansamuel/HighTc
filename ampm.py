...
sscc=loadtxt('scatter0_0_re.dat', dtype =float)
sscc1=loadtxt('scatter0_0.03_re.dat', dtype =float)   
sscc2=loadtxt('scatter1_0_re.dat', dtype =float)   
sscc3=loadtxt('scatter1_0.03_re.dat', dtype =float)   


ssii=loadtxt('scatter0_0_imag.dat', dtype =float)
ssii1=loadtxt('scatter0_0.03_imag.dat', dtype =float)   
ssii2=loadtxt('scatter1_0_imag.dat', dtype =float)   
ssii3=loadtxt('scatter1_0.03_imag.dat', dtype =float)   
...
ff1=open('scatter0_0.dat','w')
ff2=open('scatter0_0.03.dat','w')
ff3=open('scatter1_0.dat','w')
ff4=open('scatter1_0.03.dat','w')
