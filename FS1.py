...
N1=200
NB=200
ff1=open('spec1m_eta_0.1.dat','w')
ff2=open('spec1m1_eta_0.1.dat','w')
ff3=open('spec1m2_eta_0.1.dat','w')
ff4=open('spec1m3_eta_0.1.dat','w')
ff5=open('spec1m4_eta_0.1.dat','w')
ff6=open('spec1m5_eta_0.1.dat','w')
ff7=open('spec1m6_eta_0.1.dat','w')
ff8=open('spec1m7_eta_0.1.dat','w')
...
def GG(omega,px,py,t,t1,t2,t3,t4):
   GG=1.0/(omega-tb(px,py,t,t1,t2,t3,t4)-Self(omega,px,py,t,t1,t2,t3,t4)+eta*1j) 
   return GG
   ...
   for ix in range(N1):
    for iy in range(N1):
     ...
     if tb(px,py,t,t1,t2,t3,t4)-tb(px+pi+qx,py+pi+qy,t,t1,t2,t3,t4)>ww and tb(px+qx,py+qy,t,t1,t2,t3,t4)<tb(px,py,t,t1,t2,t3,t4):
       SS+=pi/2*(1-12*ww**2)/(1+12*ww**2)*(1-dop)**2*(tb(px+qx,py+qy,t,t1,t2,t3,t4))**2/(omega-tb(px+pi+qx,py+pi+qy,t,t1,t2,t3,t4)-wwq+eta*1j)
       NS+=1
  SS=SS/N1**2
  return SS
