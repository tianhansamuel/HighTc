...
sscc=loadtxt('ref2_0.05re.dat', dtype =float)  
ssii=loadtxt('ref2_0.05imag.dat', dtype =float)   

sscc1=loadtxt('refn2_0.05re.dat', dtype =float)  
ssii1=loadtxt('refn2_0.05imag.dat', dtype =float)   


SS1=shape(sscc)
VS=0.1

ff1=open('ref2_0.05.dat','w')

ff2=open('impref2_0.05.dat','w')
