...
N1=70
NB=300
ff1=open('test_single_0.05_mm.dat','w')
...
def GG(omega,px,py,t,t1,t2,t3,t4,aa,dop,mu):
   GG=1.0/(omega-tb(px,py,t,t1,t2,t3,t4)+mu-Self(omega,px,py,t,t1,t2,t3,t4,aa,dop,mu)+eta*1j) 
   return GG
   ...
   for ix in range(N1):
    for iy in range(N1):
     ...
     if tb(px,py,t,t1,t2,t3,t4)-tb(px+pi+qx,py+pi+qy,t,t1,t2,t3,t4)>ww and tb(px+qx,py+qy,t,t1,t2,t3,t4)<=tb(px,py,t,t1,t2,t3,t4):
       SS+=pi*(1-12*aa**2)/(1+12*aa**2)*(1-dop)**2*(tb(px+qx,py+qy,t,t1,t2,t3,t4))**2/(omega-tb(px+pi+qx,py+pi+qy,t,t1,t2,t3,t4)+mu-wwq+eta*1j)
       NS+=1
  SS=SS/NS
  return SS
